                            ...
                            <div class="col-lg-10 mx-auto">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <form action="authen?action=edit-infor" method="POST" id="signUpForm">
                                            <div class="form-group" style="display: none">
                                                <input value = "${account.id}"type="text" class="form-control" id="idEditInput" name="id">
                                        </div>
                                        <label for="register-name">
                                            Username
                                            <span class="required">*</span>
                                        </label>
                                        <input value = "${account.username}" type="text" name="username" class="form-input form-wide" id="register-name" required />

                                        <label for="register-email">
                                            Email Address
                                            <span class="required">*</span>
                                        </label>
                                        <input value = "${account.email}"  type="email" name="email" class="form-input form-wide" id="register-email" required />

                                        <label for="register-address">
                                            Address
                                            <span class="required">*</span>
                                        </label>
                                        <input value = "${account.address}"  type="text" name="address" class="form-input form-wide" id="register-address" required />

                                        <label for="register-password">
                                            Password
                                            <span class="required">*</span>
                                        </label>
                                        <input  value = "${account.password}" type="password" name="password" class="form-input form-wide" id="register-password" required />

                                        <label for="register-confirm-password">
                                            Mật khẩu xác nhận
                                            <span class="required">*</span>
                                        </label>
                                        <input  value = "${account.password}" type="password" name="confirm_password" class="form-input form-wide" id="register-confirm-password" required />
                                        <div id="password-error" class="error-message"></div>

                                        <button type="submit" class="btn btn-cat btn-md w-100">
                                            <a href="#"
                                               onclick="document.querySelector('#signUpForm').submit()">Cập nhật</a>
                                        </button>
                                    </form>
                                </div>
                            </div>
