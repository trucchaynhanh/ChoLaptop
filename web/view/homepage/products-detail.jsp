                        ...
                        <div class="tab-content">
                                ...
                                <div class="product-desc-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex align-items-center justify-content-center">
                                            <img src="${pageContext.request.contextPath}/images/products/single/product-img.jpg" class="pt-0" width="276" height="275" alt="image desc" />
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="product-size-content" role="tabpanel" aria-labelledby="product-tab-size">
                                <div class="product-size-content">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="${pageContext.request.contextPath}/images/products/single/body-shape.png" alt="body shape" width="217" height="398">
                                        </div>
                                        <!-- End .col-md-4 -->
                                    ...
                                    <div class="comment-list">
                                        <div class="comments">
                                            <figure class="img-thumbnail">
                                                <img src="${pageContext.request.contextPath}/images/blog/author.jpg" alt="author" width="80" height="80">
                                            </figure>
                    ...
                    <div class="products-section pt-0 pb-2">
                        ...
                        <div class="products-slider owl-carousel owl-theme dots-top dots-small">
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/demoes/demo2/products/product-1.jpg" width="265" height="265" alt="product" />
                                        <img src="${pageContext.request.contextPath}/images/demoes/demo2/products/product-1-2.jpg" width="265" height="265" alt="product" />
                                    </a>
                                    <div class="label-group">
                                        <div class="product-label label-hot">HOT</div>
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="product.html">
                                        <img src="${pageContext.request.contextPath}/images/demoes/demo2/products/product-2.jpg" width="265" height="265" alt="product" />
                                    </a>
                                    <div class="btn-icon-group">
                                        <a href="demo2-product.html" class="btn-icon btn-add-cart"><i
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/demoes/demo2/products/product-3.jpg" width="265" height="265" alt="product" />
                                    </a>
                                    <div class="btn-icon-group">
                                        <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                class="icon-shopping-cart"></i></a>
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/demoes/demo2/products/product-4.jpg" width="265" height="265" alt="product">
                                    </a>
                                    <div class="btn-icon-group">
                                        <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                class="icon-shopping-cart"></i></a>
                            ...
                            <div class="product-default inner-quickview inner-icon">
                                <figure class="img-effect">
                                    <a href="product.html">
                                        <img src="${pageContext.request.contextPath}/images/demoes/demo2/products/product-5.jpg" width="265" height="265" alt="product" />
                                    </a>
                                    <div class="btn-icon-group">
                                        <a href="#" class="btn-icon btn-add-cart product-type-simple"><i
                                                class="icon-shopping-cart"></i></a>
                    ...
                    <div class="product-widgets-container row pb-2">
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-1.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-1-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Ultimate 3D Bluetooth
                                            Speaker</a> </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-2.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-2-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Brown Women Casual HandBag</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-3.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-3-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Circled Ultimate 3D Speaker</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-4.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-4-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Blue Backpack for the Young -
                                            S</a> </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-5.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-5-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Casual Spring Blue Shoes</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-6.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-6-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Men Black Gentle Belt</a> </h3>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-7.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-7-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Brown-Black Men Casual
                                            Glasses</a> </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-8.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-8-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-9.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-9-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Black Men Casual Glasses</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-10.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-10-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Basketball Sports Blue Shoes</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-11.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-11-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Men Sports Travel Bag</a> </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="demo2-product.html">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-12.jpg" width="74" height="74" alt="product">
                                        <img src="${pageContext.request.contextPath}/images/products/small/product-12-2.jpg" width="74" height="74" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="demo2-product.html">Brown HandBag</a> </h3>
